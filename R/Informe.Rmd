...
```{r,echo=FALSE}
suppressWarnings(library(vgjsmParser))


doc <- vgjsmParser::readXMLFile(file = "../inst/extdata/nvdcve-2.0-2016.xml")

#head(dff,n=5)
```

```{r cargando, cache=TRUE}
df <- vgjsmParser::crear_dataframe(doc)
```

You can also embed `r df[1,1]` plots, for example:
